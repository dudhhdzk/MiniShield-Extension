...
<p align="center">
    <b>MiniShield-Extension</b> is a multifunctional browser extension that not only blocks trackers and ads but also provides deep threat analysis using neural networks, integration with antivirus databases, have anonymous mail, autofill, cookie blocker and smart data management, autofill mail code and anymore feature.
</p>
